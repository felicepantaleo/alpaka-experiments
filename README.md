...
nvcc -x cu -w --generate-code arch=compute_70,code=sm_70 -O2 -std=c++14 --expt-relaxed-constexpr -include "cupla/standalone/GpuCudaRt.hpp" -DCUPLA_STREAM_ASYNC_ENABLED=0 -DALPAKA_DEBUG=1 -I$PROJECT_DIR/cupla/alpaka/include -I$PROJECT_DIR/cupla//include -I /usr/local/cuda/samples/common/inc/ -I$PROJECT_DIR/boost_1_70_0 matrixMul.cpp -o matrixMul
```
